...
//==============================================================================================================================
//Defining
#define PORT 8766 //This is the port number for the Smain server
#define SPDF_PORT 8887 //This is the port number for the Spdf server 
#define STEXT_PORT 8798 //This is the port number for the Stext server 
...
void forward_delete_request(const char *service, const char *filename) {// Function to forward a delete request to a specified service
    ...
    printf("Response from %s server: %s\n", service, response);
